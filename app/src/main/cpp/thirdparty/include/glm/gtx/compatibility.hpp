...
namespace glm {
    ...
    template<typename T, qualifier Q>
    GLM_FUNC_DECL vec<1, bool, Q> isfinite(
    ...
    template<typename T, qualifier Q>
    GLM_FUNC_DECL vec<2, bool, Q> isfinite(
    ...
    template<typename T, qualifier Q>
    GLM_FUNC_DECL vec<3, bool, Q> isfinite(
    ...
    template<typename T, qualifier Q>
    GLM_FUNC_DECL vec<4, bool, Q> isfinite(
            const vec<4, T, Q> &x);                //!< \brief Test whether or not a scalar or each vector component is a finite value. (From GLM_GTX_compatibility)
