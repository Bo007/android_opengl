...
{
return
detail::functor1<vec, L, T, T, Q>::call(fastSqrt, x
);
}
...
#		else
return
detail::compute_inversesqrt<1, genType, lowp, detail::is_aligned<lowp>::value>::call(vec<1, genType, lowp>(x)
).
x;
#		endif
}
...
template<length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<L, T, Q>
fastInverseSqrt(vec<L, T, Q>
const& x)
{
return
detail::compute_inversesqrt<L, T, Q, detail::is_aligned<Q>::value>::call(x);
}
