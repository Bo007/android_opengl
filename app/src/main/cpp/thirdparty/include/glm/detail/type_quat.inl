...
#	endif
    ...
    GLM_FUNC_QUALIFIER qua<T, Q>::qua(vec<3, T, Q> const &u, vec<3, T, Q> const &v) {
        ...
        if (real_part < static_cast<T>(1.e-6f) * norm_u_norm_v) {
            ...
            t = abs(u.x) > abs(u.z) ? vec<3, T, Q>(-u.y, u.x, static_cast<T>(0)) : vec<3, T, Q>(static_cast<T>(0), -u.z,
                                                                                                u.y);
        } else {
...
#	endif
    ...
    GLM_FUNC_QUALIFIER qua<T, Q> &qua<T, Q>::operator*=(U s) {
        return (*this = detail::compute_quat_mul_scalar<T, Q, detail::is_aligned<Q>::value>::call(*this,
                                                                                                  static_cast<U>(s)));
    }
    ...
    template<typename U>
    GLM_FUNC_QUALIFIER qua<T, Q> &qua<T, Q>::operator/=(U s) {
        return (*this = detail::compute_quat_div_scalar<T, Q, detail::is_aligned<Q>::value>::call(*this,
                                                                                                  static_cast<U>(s)));
    }
